 ...
 * the audio communication widget. It then makes sure that the browser renders the correct audio communication
 * widget HTML only.
 */
define(['angular', 'TestTemplateCacheList', 'angular-mocks', 'directives/index', 'controllers/index', 'services/index'], function (ng, TestTemplateCacheList) {
    ...
    describe('Test that a configuration containing the Audio Communication widget only, renders the Audio widget and no other' +
        ...
        it('Should not render the video communication widget  ', function () {
            ...
            expect(hasFeatureList['video']).toBeFalsy();
