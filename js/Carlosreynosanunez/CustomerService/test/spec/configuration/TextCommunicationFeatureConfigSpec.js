 ...
 * the audio communication widget. It then makes sure that the browser renders the correct text communication
 * widget HTML only.
 */
define(['angular', 'TestTemplateCacheList', 'angular-mocks', 'directives/index', 'controllers/index', 'services/index'], function (ng, TestTemplateCacheList) {
    ...
    describe('Test that a configuration containing the Text Communication widget only, renders the text widget and no other' +
